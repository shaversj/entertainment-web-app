...
const Nav = () => {
  ...
  const iconNavHome = (
    <svg className={"ml-auto h-4 w-4 fill-[#5A698F] hover:fill-bright-red"} viewBox={"0 0 20 20"} xmlns="http://www.w3.org/2000/svg">
  ...
  const iconNavMovies = (
    <svg className={"h-4 w-4 fill-[#5A698F] hover:fill-bright-red"} viewBox={"0 0 20 20"} xmlns="http://www.w3.org/2000/svg">
  ...
  const iconNavBookmark = (
    <svg className={"h-4 w-[0.846rem] fill-[#5A698F] hover:fill-bright-red"} viewBox={"0 0 17 20"} xmlns="http://www.w3.org/2000/svg">
