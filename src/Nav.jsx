...
const Nav = () => {
  ...
  const iconNavHome = (
    <svg className={"ml-auto h-4 w-4"} viewBox={"0 0 20 20"} xmlns="http://www.w3.org/2000/svg">
      <path
  ...
  const iconNavBookmark = (
    <svg className={"h-4 w-[0.846rem]"} viewBox={"0 0 17 20"} xmlns="http://www.w3.org/2000/svg">
      <path
