    ...
    <>
      {isTendingSection ? (
        <div id={"card"} className={"h-[140px] w-[240px] lg:h-[230px] lg:w-[470px]"}>
          <picture>
            <source srcSet={thumbnail.trending.large.substring} media="(min-width: 1440px)" />
            <img className={"rounded-lg"} src={thumbnail.trending.small.substring} alt={"Movie thumbnail"} />
          </picture>
