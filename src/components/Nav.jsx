...
const Nav = () => {
  return (
    <nav className={"flex h-[56px] items-center gap-x-[24px] bg-semi-dark-blue px-4"}>
      ...
      <div className={"ml-auto"}>
        <NavLink to={"/"}>
          {({ isActive }) => (
            <svg className={`h-4 w-4 fill-[#5A698F] hover:fill-bright-red ${isActive ? "fill-white" : "fill-[#5A698F]"}`} viewBox={"0 0 20 20"} xmlns="http://www.w3.org/2000/svg">
      ...
      <div>
        <NavLink to={"/bookmarked"}>
          {({ isActive }) => (
            <svg className={`h-4 w-4 fill-[#5A698F] hover:fill-bright-red ${isActive ? "fill-white" : "fill-[#5A698F]"}`} viewBox={"0 0 17 20"} xmlns="http://www.w3.org/2000/svg">
